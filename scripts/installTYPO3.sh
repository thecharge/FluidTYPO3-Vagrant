...
grep trustedHostsPattern /var/www/typo3conf/LocalConfiguration.php || {
	sed -i "/'SYS' =/a \\\t\t'trustedHostsPattern' => '${TRUSTED_HOSTS_PATTERN}'," /var/www/typo3conf/LocalConfiguration.php
}
